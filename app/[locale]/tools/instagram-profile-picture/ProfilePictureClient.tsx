        ...
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 py-12 px-4">
            <div className="max-w-2xl mx-auto">
                ...
                <article className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 md:p-8">
                    ...
                    <div className="mb-6">
                        <label htmlFor="instagram-profile-username" className="block text-sm font-bold text-gray-700 mb-2">
                            Username
                        </label>
                    ...
                    {isLoading && (
                        <div className="text-center py-8" aria-live="polite">
                            <div className="w-16 h-16 border-4 border-purple-200 border-t-purple-500 rounded-full animate-spin mx-auto mb-4" role="status" />
