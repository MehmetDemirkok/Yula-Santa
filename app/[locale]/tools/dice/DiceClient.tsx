    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 py-8 sm:py-12 px-4">
            ...
            <div className="max-w-lg mx-auto">
                ...
                <article className="bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl border border-white/50 p-4 sm:p-6 md:p-8">
                    <div className="mb-6 sm:mb-8">
                        <label className="block text-sm font-bold text-gray-700 mb-2 sm:mb-3" htmlFor="dice-count">
                            {t('label')}
                        </label>
                        <div className="relative">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-bold text-gray-800 text-lg">{t('option', { count: diceCount })}</span>
                                </div>
                                <ChevronDown className={`w-5 h-5 text-gray-400 transition-transform ${isDropdownOpen ? 'rotate-180' : ''}`} />
                            </button>

                            {isDropdownOpen && (
                                <div className="absolute z-50 w-full mt-2 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden animate-fade-in" role="listbox">
                                    {[1, 2].map((num) => (
                                        <button
                                            key={num}
                                            onClick={(e) => {
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 min-h-[180px] flex items-center justify-center border border-gray-200" aria-live="polite" aria-atomic="true">
                        {results.length > 0 ? (
                ...
                <section className="mt-8 bg-white/60 backdrop-blur rounded-2xl p-6 border border-gray-100">
                    ...
                    <h3 className="text-md font-semibold text-gray-700 mb-2">{t('featuresTitle')}</h3>
