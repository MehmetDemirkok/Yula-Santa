        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-950 py-12 px-4 transition-colors duration-300">
            <div className="max-w-2xl mx-auto">
                ...
                <article className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 p-6 md:p-8">
                    ...
                    <div className="mb-6">
                        <label htmlFor="instagram-username" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                            Username
                        </label>
                        <div className="flex gap-2">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 dark:focus:ring-pink-500/20 outline-none transition-all dark:text-white"
                                />
                            </div>
                            <button
                    ...
                    {isLoading && (
                        <div className="text-center py-8" aria-live="polite">
                            <div className="w-16 h-16 border-4 border-pink-200 dark:border-pink-900 border-t-pink-500 rounded-full animate-spin mx-auto mb-4" role="status" />
                    ...
                    <div className="mt-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
