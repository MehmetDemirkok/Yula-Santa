...
export default function TikTokGiveaway() {
    ...
    return (
        <main className="min-h-screen min-h-dvh flex flex-col items-center p-3 sm:p-4 relative overflow-hidden bg-gradient-to-b from-cyan-50 via-red-50 to-white safe-area-inset-bottom">
            {/* Decorative BG */}
